    ...
    <div className="bg-darkGrey text-white py-8">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-start px-4 sm:px-12">
        ...
        <div className="sm:w-1/3 flex flex-col justify-center items-center ml-4 text-center sm:text-left">
          ...
          {/* <p className={`${font.className} text-black text-5xl font-bold mb-2`}>Nexedge<span className="text-customCyan">{"  "}Solution</span></p> */}
          <p className={`${font2.className} text-md text-white leading-relaxed`}>
          Transforming Technology, Driving Success.
          </p>
          
          <div className="flex justify-center sm:justify-start space-x-4 mt-4">
            <FaFacebook className="text-customCyan hover:text-cyan-700 duration-300 text-2xl" />
            <AiFillInstagram className="text-customCyan hover:text-cyan-700 duration-300 text-2xl" />
            <FaTwitter className="text-customCyan hover:text-cyan-700 duration-300 text-2xl" />
          </div>
        </div>
        ...
        <div className="sm:w-1/3 mt-8 sm:mt-0 flex flex-col justify-center w-full text-center sm:text-left">
          ...
          />
          <button className={`${font2.className} bg-customCyan text-white px-4 py-2 rounded-full mt-4`}>
            Submit Request
          </button>
        </div>
      </div>
