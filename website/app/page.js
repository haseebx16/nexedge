  ...
  return (
      <>
        ...
        <section>
          ...
          <div className={`${font.className} bg-darkGrey h-auto p-20 space-y-16 flex flex-col justify-center items-center`}>
              <div className='text-center'>
                  <p className='text-4xl mt-4 font-extrabold text-customCyan'>About Us & What We Do</p>
